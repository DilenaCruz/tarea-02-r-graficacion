...
author: "María Dilena Cruz Fernández"
date: "2020-09-16"
output:
  html_document:
    theme: readable    
...
geom_col(fill="dark green")+
  ggtitle("Casos COVID-19 positivos en CA y Rep.Dom")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
  geom_text(aes(label=positivos), vjust=-0.4, size=3.5)+
...
geom_col(fill="blue")+
  ggtitle("Casos COVID-19 recuperados en CA y Rep.Dom")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
  geom_text(aes(label=recuperados), vjust=-0.4, size=3.5)+
  theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"))
```
...
geom_col(fill="red")+
  ggtitle("Casos COVID-19 activos en CA y Rep.Dom")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
  geom_text(aes(label=activos), vjust=-0.4, size=3.5)+
  theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"))
```
...
geom_col(fill="purple")+
  ggtitle("Casos COVID-19 fallecidos en CA y Rep.Dom")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
  geom_text(aes(label=fallecidos), vjust=-0.4, size=3.5)+
  theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"))
```
...
```{r}
library(tidyr)
acomodo<- gather(ca_covid19, condicion, cantidad, -pais)

ggplot(acomodo, aes(x = pais, y = cantidad, fill = condicion)) +
  geom_col(position = "dodge")+
  ggtitle("Comportamiento Covid-19 en centroamérica y Rep. Dominicana")+ xlab("Paises")+ ylab("Número de casos")+
  theme_classic() + theme(plot.title = element_text(hjust = 0.5, size = 11, face = "bold"), legend.position = c(0.95, 0.8))
