...
geom_col(fill="dark green")+
  ggtitle("Casos COVID-19 positivos en CA y el caribe")+
  xlab("Países")+
...
geom_col(fill="blue")+
  ggtitle("Casos COVID-19 recuperados en CA y el caribe")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
...
geom_col(fill="red")+
  ggtitle("Casos COVID-19 activos en CA y el caribe")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
...
geom_col(fill="purple")+
  ggtitle("Casos COVID-19 fallecidos en CA y el caribe")+
  xlab("Países")+
  ylab("Número de casos")+
  theme_classic()+
